...
namespace UnityStandardAssets.CrossPlatformInput
{
	...
	public class TouchPad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
		...
		public string horizontalAxisName = "HorizontalUI"; // The name given to the horizontal axis for the cross platform input
		public string verticalAxisName = "VerticalUI"; // The name given to the vertical axis for the cross platform input
